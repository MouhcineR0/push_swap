SRC = libft/ft_isalpha.c libft/ft_atoi.c libft/ft_bzero.c libft/ft_calloc.c libft/ft_isalnum.c libft/ft_isascii.c libft/ft_isdigit.c \
	...
	libft/ft_strtrim.c libft/ft_substr.c libft/ft_tolower.c libft/ft_toupper.c libft/ft_split.c libft/lst_push.c libft/lst_cpy.c \
	...
	main.c Instructions/Instruction1.c isSorted.c sort.c lst_cases.c libft/lst_sort.c
