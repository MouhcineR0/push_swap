...
SRC_PUSHSWAP = main.c Instructions/Instruction1.c Instructions/Instruction2.c Instructions/Instruction3.c isSorted.c sort.c lst_cases.c \
	lis.c handle_large.c handle_large0.c

BONUS  = bonus/getnextline/get_next_line.c bonus/getnextline/get_next_line_utils.c bonus/checker.c
...
$(BONUS_NAME) : Compiling $(LIBFT_OBJS) $(PRINTF_OBJS) $(OBJS_PUSHSWAP) $(BONUS_OBJS)
	$(CC) $(FLAGS) $(OBJS_PUSHSWAP) $(LIBFT_OBJS) $(PRINTF_OBJS) $(BONUS_OBJS) -o $(BONUS_NAME)
